...
public class ReservationController {
    ...
    public void initialize() {
        System.out.println("Initialisation du ReservationController"); // Log
        try {
            loadReservations();
            configureListView();
            System.out.println("Initialisation réussie"); // Log
        } catch (Exception e) {
    ...
    private void loadReservations() {
        try {
            ...
            System.err.println("Erreur SQL lors du chargement des réservations:");
            e.printStackTrace();
