...
public class Annonce {
    // Attributs de base
    private int id;                    // Identifiant unique de l'annonce
    ...
    private int trajetId;             // ID du trajet associé à l'annonce
     ...
     */
    public Annonce(int id, String titre, String description, Timestamp datePublication, 
                  int driverId, int carId, String status, int trajetId) {
        this.id = id;
        this.titre = titre;
